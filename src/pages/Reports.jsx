        ...
        <div style={{ height: "calc(100vh - 128px)" }} className='p-10 bg-[#f9f9fa] w-full overflow-y-scroll'>
            <div>
                <div className='flex justify-between items-center mb-6'>
                    <div>
                        <h3 className='text-2xl font-bold mb-2'>Admin Reports & Analytics</h3>
                        <p className='text-gray-400'>Generate comprehensive reports across all companies, teams, and employees</p>
                    </div>
                    ...
                    <div className='flex gap-3 items-center rounded-lg border bg-white p-7 w-full'>
                        <div className=''>
                            <div className='bg-orange-100 text-orange-700 p-4 rounded-lg '>
                                <AiOutlineRise className='text-xl m-0 p-0' />
                            </div>
                        </div>
                        <div>
                            <h4 className='font-bold text-xl'>3</h4>
